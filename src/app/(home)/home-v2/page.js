...
const Home_V2 = () => {
  return (
    <>
      ...
      {/* Our Partners */}
      <section className="our-partners pt2">
        <div className="container">
          <div className="row">
      ...
      <section className="container d-flex justify-content-center">
        <Link href="/grid-full-4-col" className="ud-btn btn-white">
          See All Properties
          <i className="fal fa-arrow-right-long" />
        </Link>
        ...
        {/*    <i className="fal fa-arrow-right-long" />*/}
        {/*  </Link>*/}
        {/*  <button className="text-center mb-3">*/}
        {/*    <Link className="ud-btn2" ">*/}
        {/*      See All Properties*/}
      ...
      <div className="banner-wrapper main-banner-wrapper  position-relative banner-style-one pb-5">
        <BannerSlider />
      </div>
      {/* End Our Partners */}
